...
<div>
  ...
  <span className='text-[#915eff]'>Sahla </span></h1>
  <p className={`${styles.heroSubText}  text-white`}>I develop Web Appilcations
  <br className='sm:block hidden'/>
  and Front-end Designs<br className=''/> using React.js</p>
</div>
</div>
<ComputersCanvas/>
